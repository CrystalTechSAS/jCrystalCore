...
public class EntityClassGenerator extends AbsEntityGenerator{
	
	
	protected final KeyConvertersClass KeyConverters;
	
	public EntityClassGenerator(ClientContext context) {
		super(context);
		...
		context.utils.converters.dates.extending(()->{
			if(back.id == null) {
				...
				new JavaCode(){{
					...
					//$append(new UtilsEntityGenerator(EntityClassGenerator.this).generate(false));
	...
	private class EntityGenerator extends InternalEntityGenerator{
		...
		protected void generateSaveMethods() {
			if(entidad.entidad.internal())
				return;
			$("public void realtimePut(String path) throws java.io.IOException",()->{
				$("com.google.api.client.http.HttpTransport httpTransport = com.google.api.client.extensions.appengine.http.UrlFetchTransport.getDefaultInstance();");
				$("com.google.api.client.http.HttpRequestFactory requestFactory = httpTransport.createRequestFactory("+context.input.SERVER.WEB.getBasePackage()+".servlets.OnLoadServlet.FIREBASE_CREDENTIALS());");
				$("java.io.ByteArrayOutputStream BAOS = new java.io.ByteArrayOutputStream();"); 
				$("try(java.io.PrintWriter pw = new java.io.PrintWriter(BAOS))",()->{
					$("Serializer"+entidad.clase.getSimpleName()+".toJson(pw, this);"); 
				});
				$("if(!path.startsWith(\"/\"))",()->{
					$("path = \"/\"+path;");
				});
				$("com.google.api.client.http.GenericUrl url = new com.google.api.client.http.GenericUrl("+context.input.SERVER.WEB.getBasePackage()+".servlets.OnLoadServlet.FIREBASE_BASE_URL + path + \".json\");");
				$("requestFactory.buildPutRequest(url, new com.google.api.client.http.ByteArrayContent(\"application/json\", BAOS.toByteArray())).execute();");
			});
			$("public void realtimePatch(String path) throws java.io.IOException",()->{
				$("com.google.api.client.http.HttpTransport httpTransport = com.google.api.client.extensions.appengine.http.UrlFetchTransport.getDefaultInstance();");
				$("com.google.api.client.http.HttpRequestFactory requestFactory = httpTransport.createRequestFactory("+context.input.SERVER.WEB.getBasePackage()+".servlets.OnLoadServlet.FIREBASE_CREDENTIALS());");
				$("java.io.ByteArrayOutputStream BAOS = new java.io.ByteArrayOutputStream();"); 
				$("try(java.io.PrintWriter pw = new java.io.PrintWriter(BAOS))",()->{
				...
				$("com.google.api.client.http.GenericUrl url = new com.google.api.client.http.GenericUrl("+context.input.SERVER.WEB.getBasePackage()+".servlets.OnLoadServlet.FIREBASE_BASE_URL + path + \".json\");");
				$("requestFactory.buildPatchRequest(url, new com.google.api.client.http.ByteArrayContent(\"application/json\", BAOS.toByteArray())).execute();");
			});
			$("public static void realtimeDelete(String path) throws java.io.IOException",()->{
				$("com.google.api.client.http.HttpTransport httpTransport = com.google.api.client.extensions.appengine.http.UrlFetchTransport.getDefaultInstance();");
				$("com.google.api.client.http.HttpRequestFactory requestFactory = httpTransport.createRequestFactory("+context.input.SERVER.WEB.getBasePackage()+".servlets.OnLoadServlet.FIREBASE_CREDENTIALS());");
				$("if(!path.startsWith(\"/\"))",()->{
					$("path = \"/\"+path;");
			...
			$("public static "+entidad.clase.getSimpleName()+" realtimeGet(String path) throws java.io.IOException",()->{
				$("com.google.api.client.http.HttpTransport httpTransport = com.google.api.client.extensions.appengine.http.UrlFetchTransport.getDefaultInstance();");
				$("com.google.api.client.http.HttpRequestFactory requestFactory = httpTransport.createRequestFactory("+context.input.SERVER.WEB.getBasePackage()+".servlets.OnLoadServlet.FIREBASE_CREDENTIALS());");
				$("if(!path.startsWith(\"/\"))",()->{
					$("path = \"/\"+path;");
				...
				$("com.google.api.client.http.GenericUrl url = new com.google.api.client.http.GenericUrl("+context.input.SERVER.WEB.getBasePackage()+".servlets.OnLoadServlet.FIREBASE_BASE_URL + path + \".json\");");
				$("com.google.api.client.http.HttpResponse r = requestFactory.buildGetRequest(url).execute();");
				$("org.json.JSONObject $body = new org.json.JSONObject(new org.json.JSONTokener(r.getContentEncoding()==null?new java.io.InputStreamReader(r.getContent()):new java.io.InputStreamReader(r.getContent(), r.getContentEncoding())));");
				$("return new "+entidad.clase.getSimpleName()+"($body);");
			});
		}
		@Override
