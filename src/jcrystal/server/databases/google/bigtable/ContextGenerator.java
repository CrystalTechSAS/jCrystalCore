...
public class ContextGenerator extends AbsContextGenerator {
	...
	public ContextGenerator(ClientContext context) {
		super(DBType.GOOGLE_BIG_QUERY, context);
	}

	@Override
	protected void generateContent() {
		$("public static java.text.SimpleDateFormat DATE_FORMAT = new java.text.SimpleDateFormat(\"yyyy-MM-dd\");"); 
		$("public static java.text.SimpleDateFormat TIMESTAMP_FORMAT = new java.text.SimpleDateFormat(\"yyyy-MM-dd HH:mm:ss\");");
		$("public static java.text.DecimalFormat DECIMAL_6 = new java.text.DecimalFormat(\"#.######\");");
